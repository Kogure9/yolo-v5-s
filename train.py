...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/medical.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='mi', help='renames results.txt to results_name.txt if supplied')
